...
public class Minimum_number_of_deletions_to_make_palindrome {
	static int minimumNumberOfDeletionsToPalindrome(String str) {
		int n = str.length();
	...
	public static void main(String[] args) {
		...
		scan.close();
		System.out.println(minimumNumberOfDeletionsToPalindrome(str));
	}
}
